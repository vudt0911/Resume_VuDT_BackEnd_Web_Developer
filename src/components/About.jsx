  ...
  return (
    ...
    >
      <div className="max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full">
        ...
        I am a fresher programmer seeking a full-time position in the field of software programming. Familiar with Java and Spring Boot framework. Have some knowledge of Javascript and ReactJS library.
        </p>
